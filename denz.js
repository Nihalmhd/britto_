...
try {
        ...
        mess = {
			...
			only: {
				...
				ownerB: '𝙾𝙽𝙻𝚈 𝙵𝙾𝚁 ✰ɪᴛsᴍᴇ ᴥ︎︎︎ ʙʀɪᴛᴛᴏ♕︎✔︎',
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© ✰ɪᴛsᴍᴇᴥ︎︎︎ʙʀɪᴛᴛᴏ♕︎✔︎_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             denz.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = denz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'ʜʏ ᴅᴜᴅᴇ....👋', "groupName": `${NamaBot}`, "footerText": "*_© _*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
		...
		const sekarang = new Date().getTime();
			...
			var ase = new Date();
                        var jamss = ase.getHours();
                         switch(jamss){
                case 0: jamss = "𝙼𝙸𝙳 𝙽𝙸𝙶𝙷𝚃 🌉"; break;
                case 1: jamss = "𝙼𝙸𝙳 𝙽𝙸𝙶𝙷𝚃 🌉"; break;
                case 2: jamss = "𝙼𝙸𝙳 𝙽𝙸𝙶𝙷𝚃 🌉"; break;
                case 3: jamss = "𝙼𝙸𝙳 𝙽𝙸𝙶𝙷𝚃 🌉"; break;
                case 4: jamss = "𝙼𝙸𝙳 𝙽𝙸𝙶𝙷𝚃 🌉"; break;
                case 5: jamss = "𝙶𝙾𝙾𝙳 𝙼𝙾𝚁𝙽𝙸𝙽𝙶 🌄"; break;
                case 6: jamss = "𝙶𝙾𝙾𝙳 𝙼𝙾𝚁𝙽𝙸𝙽𝙶 🌄"; break;
                case 7: jamss = "𝙶𝙾𝙾𝙳 𝙼𝙾𝚁𝙽𝙸𝙽𝙶 🌄"; break;
                case 8: jamss = "𝙵𝙾𝙾𝙳 𝙺𝙰𝚉𝙷𝙸𝙲𝙷𝙾 🍜️"; break;
                case 9: jamss = "𝙵𝙾𝙾𝙳 𝙺𝙰𝚉𝙷𝙸𝙲𝙷𝙾 🍜️"; break;
                case 10: jamss = "𝙵𝙾𝙾𝙳 𝙺𝙰𝚉𝙷𝙸𝙲𝙷𝙾 🍜️"; break;
                case 11: jamss = "𝚄𝙲𝙷𝙰 𝙰𝚈𝙸 𝙺𝙴𝚃𝚃𝙾 🌅"; break;
                case 12: jamss = "𝙲𝙷𝙾𝙾𝚁 𝙺𝙰𝚉𝙷𝙸𝙲𝙾 🍚"; break;
                case 13: jamss = "𝙲𝙷𝙾𝙾𝚁 𝙺𝙰𝚉𝙷𝙸𝙲𝙾 🍚"; break;
                case 14: jamss = "𝙲𝙷𝙾𝙾𝚁 𝙺𝙰𝚉𝙷𝙸𝙲𝙾 🍚"; break;
                case 15: jamss = "𝙴𝚅𝙴𝙽𝙸𝙽𝙶 𝙰𝚅𝙰𝚁𝙴 𝙰𝚈𝙸 🏝️"; break;
                case 16: jamss = "️𝚄𝙲𝙷𝙰 𝙰𝚈𝙸 🏜️"; break;
                case 17: jamss = "𝙴𝚅𝙴𝙽𝙸𝙽𝙶 𝙰𝚈𝙸 🌅"; break;
                case 18: jamss = "𝙽𝙸𝙶𝙷𝚃 𝙰𝚅𝙰𝚁𝙴 𝙰𝚈𝙸 🌃"; break;
                case 19: jamss = "𝚁𝙰𝚃𝙷𝚁𝙸 𝙰𝚈𝙸 🌃"; break;
                case 20: jamss = "𝚁𝙰𝚃𝙷𝚁𝙸 𝙰𝚈𝙸 🌃"; break;
                case 21: jamss = "𝚁𝙰𝚃𝙷𝚁𝙸 𝙰𝚈𝙸 🌃"; break;
                case 22: jamss = "𝙼𝙸𝙳𝙽𝙸𝙶𝙷𝚃 🌉"; break;
                case 23: jamss = "𝙼𝙸𝙳𝙽𝙸𝙶𝙷𝚃 🌉"; break;
            }
...
denz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Sorry it seems at this time ${NamaOwner} currently Offline\n\n*Reason :* ${alasanafk}\n*Since :* ${heheh.hours} Hour, ${heheh.minutes} Minutes, ${heheh.seconds} second\n\nPlease contact again after Online`, "*_© ✰ɪᴛsᴍᴇᴥ︎︎︎ʙʀɪᴛᴛᴏ♕︎✔︎_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `✰ɪᴛsᴍᴇᴥ︎︎︎ʙʀɪᴛᴛᴏ♕︎✔︎`,body:"",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/919567941560?text=Hi bro`}}})
		}
		const reply2 = (teks) => {
...
fill =`༄ʜʏ ᴅᴜᴅᴇ... ${pushname}, ${tampilUcapan}
sᴇʟᴇᴄᴛ ᴍᴇɴᴜ☟︎︎︎..

If the button doesnt appear, type .allmenu
`
menu =`✰ɪᴛsᴍᴇ ᴥ︎︎︎ ʙʀɪᴛᴛᴏ♕︎✔︎`
gbutsan = [
...
☯ 𝙳𝙰𝚈 : ${week} ${weton}
☯ 𝙳𝙰𝚃𝙴 : ${calender}`
sendButLocation(from, `${menu}`, "✰ɪᴛsᴍᴇᴥ︎︎︎ʙʀɪᴛᴛᴏ♕︎✔︎", {jpegThumbnail:gambar,name:""}, [
{buttonId:`allmenu`,buttonText:{displayText:'SHOW MENU'},type:1},
{buttonId:`owner`,buttonText:{displayText:'😎OWNER'},type:1},
{buttonId:`script`,buttonText:{displayText:'📃SCRIPT'},type:1}
...
│
├🌹 𝙿𝚁𝙸𝚅𝙰𝚃𝙴 𝙱𝙾𝚃 𝙰𝙽𝙽 𝙼𝚆𝙽𝙾𝙴
│
├🦋 𝙷𝙴𝙻𝙿𝙴𝙳 𝙱𝚈 𝙹𝙸𝙽𝙽 𝚂𝙸𝚁 ❣️
│
├🌹 𝙲𝚁𝙴𝙰𝚃𝙾𝚁 : *✰ʙʀɪᴛᴛᴏ♕︎✔︎*
│
├🦋 𝙲𝙾𝙽𝚃𝙰𝙲𝚃 𝙼𝙴 : wa.me/919567941560
│
├🌹 𝚄𝚂𝙴 𝙼𝙴𝙽𝚄✰
│
├🦋 .allmenu
...
├🌹 .othermenu
│
├❣️ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎❣️
├𖨆 *✰ɪᴛsᴍᴇ ᴥ︎︎︎ ʙʀɪᴛᴛᴏ♕︎✔︎*
└─────────────────❒`
sendButLocation(from, `${menu}`, "✰ɪᴛsᴍᴇᴥ︎︎︎ʙʀɪᴛᴛᴏ♕︎✔︎", {jpegThumbnail:gambar,name:""}, [{buttonId:`owner`,buttonText:{displayText:'🐦OWNER'},type:1},{buttonId:`script`,buttonText:{displayText:'📒SCRIPT'},type:1}], {contextInfo: { mentionedJid: [otod]}})
break
case 'menu':
 stod = `${sender}`
 listMsg = {
 buttonText: '𝙻𝙸𝚂𝚃 𝙼𝙴𝙽𝚄⁩',
 footerText: '*_© ✰ɪᴛsᴍᴇᴥ︎︎︎ʙʀɪᴛᴛᴏ♕︎✔︎_*',
 description: `ʜʏ ᴅᴜᴅᴇ @${stod.split('@')[0]}, 𝚃𝙷𝙸𝚂 𝙸𝚂 𝙻𝙸𝚂𝚃 𝙼𝙴𝙽𝚄`,
 sections: [
                     {
                      "title": `✰ɪᴛsᴍᴇᴥ︎︎︎ʙʀɪᴛᴛᴏ♕︎✔︎`,
 rows: [
                          {
                              "title": "Script",
                              "rowId": ""
...
case 'ownermenu':
menu = `❏ 「 \`\`\`𝙾𝙽𝚆𝙴𝚁 𝙼𝙴𝙽𝚄\`\`\` 」
⌨︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎⌨︎
...
🌺 ${prefix}upswimage [ _𝚛𝚎𝚙??𝚢 𝚒𝚖𝚊𝚐𝚎 𝚠𝚒𝚝𝚐 𝚌𝚊𝚙𝚝𝚒𝚘𝚗_ ]
...
case 'downloadmenu':
menu = `❏ 「 \`\`\`𝙳𝙾𝚆𝙽𝙻𝙾𝙰𝙳 𝙼𝙴𝙽𝚄\`\`\` 」
⌨︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎ᴥ︎︎︎⌨︎
│
✰❥︎︎ ${prefix}infogempa
│
✰❥︎︎ ${prefix}herolist
│
✰❥︎︎ ${prefix}herodetail [ _𝙷𝚎𝚛𝚘_ ]
│
✰❥︎︎ ${prefix}google [ _𝚂𝚎𝚊𝚛𝚌𝚑_ ]
│
✰❥︎︎ ${prefix}gimage [ _𝚂𝚎𝚊𝚛𝚌𝚑_ ]
│
✰❥︎︎ ${prefix}wiki [ _𝚂𝚎𝚊𝚛𝚌𝚑_ ]
│
✰❥︎︎ ${prefix}mediafire [ _𝙻𝚒𝚗𝚔_ ]
│
✰❥︎︎ ${prefix}ytsearch [ _𝚃𝚒𝚝𝚕𝚎_ ]
│
✰❥︎︎ ${prefix}ytmp4 [ _𝚈𝚃 𝙻𝚒𝚗𝚔_ ]
│
✰❥︎︎ ${prefix}ytmp3 [ _𝚈𝚃 𝙻𝚒𝚗𝚔_ ]
│
✰❥︎︎ ${prefix}play [ _𝚃𝚒𝚕𝚝𝚎 𝚘𝚏 𝚜𝚘𝚗𝚐_ ]
│
✰❥︎︎ ${prefix}video [ _𝚃𝚒𝚝𝚕𝚎 𝚘𝚏 𝚟𝚒𝚍𝚎𝚘_ ]
│
✰❥︎︎ ${prefix}tinyurl [ _𝙻𝚒𝚗𝚔_ ]
│
✰❥︎︎ ${prefix}fetch [ _𝙻𝚒𝚗𝚔_ ]
│
✰❥︎︎ ${prefix}igdl [ _𝙻𝚒𝚗𝚔_ ]
│
✰❥︎︎ ${prefix}tiktokdl [ _𝙻𝚒𝚗𝚔_ ]
│
✰❥︎︎ ${prefix}pinterest [ _𝚂𝚎𝚊𝚛𝚌𝚑_ ]
│
✰❥︎︎ ${prefix}lirik [ _𝚃𝚒𝚝𝚕𝚎_ ]
│
✰❥︎︎ ${prefix}tourl [ _𝚁𝚎𝚙𝚕𝚢 𝚝𝚘 𝚒𝚖𝚊𝚐𝚎/𝚅𝚒𝚍𝚎𝚘_ ]
│
✰❥︎︎ ${prefix}resepmasakan [ _𝚃𝚒𝚝𝚕𝚎_ ]
│
✰❥︎︎ ${prefix}artimimpi [ _𝚃𝚎𝚡𝚝_ ]
│
✰❥︎︎ ${prefix}bilangangka [ _𝙽𝚞𝚖𝚋𝚎𝚛_ ]
│
✰❥︎︎ ${prefix}kalkulator [ _𝙽𝚞𝚖𝚋𝚎𝚛_ ]
│
✰❥︎︎ ${prefix}fancytext [ _𝚃𝚎𝚡𝚝_ ]
│
✰❥︎︎ ${prefix}githubstalk [ _𝚄𝚜𝚎𝚛𝚗𝚊𝚖𝚎_ ]
│
✰❥︎︎ ${prefix}translate [ _𝙻𝚊𝚗𝚐𝚞𝚊𝚐𝚎|𝚃𝚎𝚡𝚝_ ]
│
✰❥ ${prefix}ss [ _link_ ]`
katalog(menu)
break
...
🦋☼︎${prefix}matrix [ _𝚃𝚎𝚡𝚝_ ]

🦋☼︎${prefix}googletxt [ _𝚃𝚎𝚡𝚝_ ]

🦋☼︎${prefix}spiderman [ _𝚃𝚎𝚡𝚝_ ]

🦋☼︎${prefix}express [ _𝚃𝚎𝚡𝚝_ ]

🦋☼︎${prefix}dance [ _𝚃𝚎𝚡𝚝_ ]

🦋☼︎${prefix}blackbird [ _𝚃𝚎𝚡𝚝_ ]

🦋☼︎${prefix}halloween [ _𝚃𝚎𝚡𝚝_ ]

🦋☼︎${prefix}vampire [ _𝚃𝚎𝚡𝚝_ ]

🦋☼︎${prefix}codetxt [ _𝚃𝚎𝚡𝚝_ ]

🦋☼︎${prefix}text3d [ _𝚃𝚎𝚡𝚝_ ]

🦋☼︎${prefix}warrior [ _𝚃𝚎𝚡𝚝_ ]`
katalog(menu)
break
case 'groupmenu':
menu = `❏ 「 \`\`\`𝙶𝚁𝙾𝚄𝙿 𝙼𝙴𝙽𝚄\`\`\` 」
...
🦋⃝❉⃟࿔ꦿ ${prefix}getpict [ _@𝚃𝚊𝚐_ ]

🦋⃝❉⃟࿔ꦿ ${prefix}getname [ _𝚁𝚎𝚙𝚕𝚢 𝚃𝚊𝚛𝚐𝚎𝚝_ ]

🦋⃝❉⃟࿔ꦿ ${prefix}getbio [ _𝚁𝚎𝚙𝚕𝚢 𝚃𝚊𝚛𝚐𝚎𝚝_ ]

🦋⃝❉⃟࿔ꦿ ${prefix}promote [ _@𝚃𝚊𝚐_ ]
...
🦋⃝❉⃟࿔ꦿ ${prefix}getdeskgc

🦋⃝❉⃟࿔ꦿ ${prefix}sider [ _𝚁𝚎𝚙𝚕𝚢 𝙼𝚊𝚜𝚜𝚊𝚐𝚎 𝙱𝚘𝚝_ ]

🦋⃝❉⃟࿔ꦿ ${prefix}hacked [ _𝚃𝚎𝚡𝚝_ ]

🦋⃝❉⃟࿔ꦿ ${prefix}setnamegc [ _𝚃𝚎𝚡𝚝_ ]

🦋⃝❉⃟࿔ꦿ ${prefix}setdeskgc [ _𝚃𝚎𝚡𝚝_ ]

🦋⃝❉⃟࿔ꦿ ${prefix}fitnah [ _@𝚃𝚊𝚐|𝚃𝚎𝚡𝚝1|𝚃𝚎𝚡𝚝2_ ]

🦋⃝❉⃟࿔ꦿ ${prefix}kontak [ _@𝚃𝚊𝚐|𝙽𝚊𝚖𝚎_ ]

🦋⃝❉⃟࿔ꦿ ${prefix}kontag [ _@𝚃𝚊𝚐|𝙽𝚊𝚖𝚎_ ]

🦋⃝❉⃟࿔ꦿ ${prefix}opengc

🦋⃝❉⃟࿔ꦿ ${prefix}closegc

🦋⃝❉⃟࿔ꦿ ${prefix}resetlinkgc

🦋⃝❉⃟࿔ꦿ ${prefix}linkgrup

🦋⃝❉⃟࿔ꦿ ${prefix}hidetag [ _𝚃𝚎𝚡𝚝_ ]

🦋⃝❉⃟࿔ꦿ ${prefix}sticktag [ _𝙽𝚊𝚖𝚎 𝚂𝚝𝚒𝚌𝚔𝚎𝚛_ ]

🦋⃝❉⃟࿔ꦿ ${prefix}totag [ _𝚁𝚎𝚙𝚕𝚢 𝙼𝚎𝚍𝚒𝚊_ ]`
katalog(menu)
break
case 'othermenu':
menu = `❏ 「 \`\`\`𝙾𝚃𝙷𝙴𝚁 𝙼𝙴𝙽𝚄\`\`\` 」
...
👻🎗️ ${prefix}caripesan [ _𝚃𝚎𝚡𝚝|𝙰𝚖𝚘𝚞𝚗𝚝_ ]

👻🎗️ ${prefix}slots

👻🎗️ ${prefix}suit [ _𝚂𝚌𝚒𝚜𝚜𝚘𝚛𝚜/𝚂𝚝𝚘𝚗𝚎/𝙿𝚊𝚙𝚎𝚛_ ]

👻🎗️ ${prefix}tag [ _𝙽𝚞𝚖𝚋𝚎𝚛_ ]

👻🎗️ ${prefix}tagme

👻🎗️ ${prefix}tts [ _𝚃𝚎𝚡𝚝 𝙲𝚘𝚍𝚎_ ]

👻🎗️ ${prefix}readmore [ _𝚃𝚎𝚡𝚝1|𝚃𝚎𝚡𝚝2_ ]

👻🎗️ ${prefix}fitnahpc [ _𝙽𝚞𝚖𝚋𝚎𝚛|𝚃𝚎𝚡𝚝1|𝚃𝚎𝚡𝚝2_ ]

👻🎗️ ${prefix}chat [ _𝙽𝚞𝚖𝚋𝚎𝚛|𝚃𝚎𝚡𝚝_ ]

👻🎗️ ${prefix}fdeface [ _𝚁𝚎𝚙𝚕𝚢𝚒𝚖𝚐 𝙻𝚒𝚗𝚔|𝚃𝚎𝚡𝚝1|𝚃𝚎𝚡𝚝2_ ]
...
👻🎗️ ${prefix}baileys [ _𝚁𝚎𝚙𝚕𝚢 𝙼𝚎𝚜𝚜𝚊𝚐𝚎_ ]

👻🎗️ ${prefix}q [ _𝚁𝚎𝚙𝚕𝚢 𝙼𝚊𝚜𝚜𝚊𝚐𝚎_ ]

👻🎗️ ${prefix}getcaption [ _𝚁𝚎𝚙𝚕𝚢 𝙼𝚎𝚜𝚜𝚊𝚐𝚎_ ]

👻🎗️ ${prefix}pantun

👻🎗️ ${prefix}tospam [ _𝚁𝚎𝚙𝚕𝚢 𝙰𝚞𝚍𝚒𝚘/𝚂𝚝𝚒𝚌𝚔𝚎𝚛/𝙸𝚖𝚊𝚐𝚎|𝙰𝚖𝚘𝚞𝚗𝚝_ ]

👻🎗️ ${prefix}sharelock [ _𝚃𝚎𝚡𝚝1|𝚃𝚎𝚡𝚝2_ ]

👻🎗️ ${prefix}sticker

👻🎗️ ${prefix}stickerwm [ _𝙽𝚊𝚖𝚎|𝙰𝚞𝚝𝚑𝚘𝚛_ ]

👻🎗️ ${prefix}takestick [ _𝙽𝚊𝚖𝚎|𝙰𝚞𝚝𝚑𝚘𝚛_ ]

👻🎗️ ${prefix}colong [ _𝚁𝚎𝚙𝚕𝚢 𝚂𝚝𝚒𝚌𝚔𝚎𝚛_ ]

👻🎗️ ${prefix}dadu

👻🎗️ ${prefix}semoji [ _𝙴𝚖𝚘𝚓𝚒_ ]

👻🎗️ ${prefix}attp [ _𝚃𝚎𝚡𝚝_ ]

👻🎗️ ${prefix}toimg

👻🎗️ ${prefix}tomp3 [ _𝚁𝚎𝚙𝚕𝚢 𝚅𝚒𝚍𝚎𝚘_ ]

👻🎗️ ${prefix}tomp4 [ _𝚁𝚎𝚙𝚕𝚢 𝚂𝚝𝚒𝚌𝚔𝚎𝚛 𝙶𝚒𝚏_ ]

👻🎗️ ${prefix}robot [ _𝚁𝚎𝚙𝚕𝚢 𝙰𝚞𝚍𝚒𝚘_ ]

👻🎗️ ${prefix}balik [ _𝚁𝚎𝚙𝚕𝚢 𝙰𝚞𝚍𝚒𝚘_ ]

👻🎗️ ${prefix}bass [ _𝚁𝚎𝚙𝚕𝚢 𝙰𝚞𝚍𝚒𝚘_ ]

👻🎗️ ${prefix}gemuk [ _𝚁𝚎𝚙𝚕𝚢 𝙰𝚞𝚍𝚒𝚘_ ]

👻🎗️ ${prefix}detikvn [ _𝚁𝚎𝚙𝚕𝚢 𝙰𝚞𝚍𝚒𝚘 𝙲𝚊𝚙𝚝𝚒𝚘𝚗 𝙽𝚞𝚖𝚋𝚎𝚛_ ]

👻🎗️ ${prefix}detikvideo [ _𝚁𝚎𝚙𝚕𝚢 𝚅𝚒𝚍𝚎𝚘 𝙲𝚊𝚙𝚝𝚒𝚘𝚗 𝙽𝚞𝚖𝚋𝚎𝚛_ ]`
katalog(menu)
break
//Now
case 'nuliskiri':
...
imageMessage: mhan.message.imageMessage,
contentText: `𝙱𝚘𝚜𝚜`,
footerText: '*_©✰ɪᴛsᴍᴇ ᴥ︎︎︎ ʙʀɪᴛᴛᴏ♕︎✔︎_*',
buttons: gbutsan,
headerType: 4
}
...
break
		...
		case 'sourcecode':
		anu =`╭─❒ SCRIPT
│➩➬𝙱𝙰𝚂𝙴 : *✰ɪᴛsᴍᴇ ᴥ︎︎︎ ʙʀɪᴛᴛᴏ♕︎✔︎*
│➩➬𝙴𝚁𝚁𝙾𝚁 𝙲𝙷𝙴𝙲𝙺𝙸𝙽𝙶 : *✩ʙʀɪᴛᴛᴏ✔︎*
│
└──────[ 𝚂𝙲𝚁𝙸𝙿𝚃 ]──────❒
  │➬➩ : 𝙽𝙾𝚃 𝚁𝙴𝙻𝙴𝙰𝚂𝙴𝙳 𝚈𝙴𝚃
  └──────────────────❒`
...
Giliran = @${tty.player1.split('@')[0]}`
 denz.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     denz.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Britto ser",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://wa.me/919567941560?text=Hi Bro"}}})
	}
    }
    }
    }
